    ...
    return (
      <main className="min-h-screen bg-[#F5F6F8] p-6">
        <div className="mx-auto max-w-md rounded-2xl border border-gray-200 bg-white p-6">
          <h1 className="mb-1 text-lg font-bold text-gray-900">지난 기록</h1>
          <p className="mb-4 text-sm text-gray-400">
            이미 결과가 기록된 포지션은 기록을 보존하기 위해 수정할 수 없어요. 트레이더가 새
            포지션을 잡았다면 &lsquo;+ 추가&rsquo;로 새 항목을 만들어주세요.
          </p>
          <div className="flex flex-col gap-2 rounded-lg bg-gray-50 p-4 text-sm text-gray-700">
  ...
  return (
    <main className="min-h-screen bg-[#F5F6F8] p-6">
      <div className="mx-auto flex max-w-md flex-col gap-4">
        ...
        {position.type === "actual" && (
          <div className="rounded-2xl border border-gray-200 bg-white p-6">
            <h2 className="mb-1 text-sm font-bold text-gray-900">빠른 결과 계산</h2>
            <p className="mb-3 text-xs text-gray-400">
              지금 시세 기준 수익률로 승/무/패를 자동 계산해서 위 결과 필드에 저장합니다. (+3% 이상
              승리, -3% 이하 패배, 그 사이 무승부) 저장 후에도 위 폼에서 언제든 손으로 바꿀 수
              있어요.
            </p>
